...
class DroneTunnel:
    def __init__(self, target_ip="10.42.0.1", target_port=5000):
        ...
        # Use DRONE_ID env var so this works on slave_1, slave_2, slave_3
        # Fallback to "slave_1" if not set (never hardcode "drone3")
        self.drone_id    = os.environ.get("DRONE_ID", "slave_1")
    ...
    def send_anomaly_data(self, gps_lat, gps_lon, raw_frame_stack):
        ...
        try:
            ...
            packet = {
                "type": "anomaly_report",
                "drone_id": self.drone_id,        # FIXED: was missing — master fell back to peer IP
