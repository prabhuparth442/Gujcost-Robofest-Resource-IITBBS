    ...
    def _reconnect_loop(self) -> None:
        ...
        while self._running:
            try:
                ...
                # (detected by _mark_disconnected being called from send())
                self._connected_event.wait()
                # If we're here and still running, connection was lost
                if self._running and not self._connected_event.is_set():
